    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form  method="post" class="col-6" action="proses.php">
          <h3 class="text">Tambah Data Mata Kuliah</h1>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="kodemk" class="form-control" placeholder="Kode MK" name="kodemk" required="required" autofocus="autofocus">
